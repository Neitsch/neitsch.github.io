...
describe("author chip", () => {
  it("renders a heading", () => {
    ...
    expect(container).toMatchInlineSnapshot(`
      <div>
        <div
          class="MuiButtonBase-root MuiChip-root MuiChip-filled MuiChip-sizeMedium MuiChip-colorDefault MuiChip-clickable MuiChip-clickableColorDefault MuiChip-filledDefault css-1cjdymu-MuiButtonBase-root-MuiChip-root"
